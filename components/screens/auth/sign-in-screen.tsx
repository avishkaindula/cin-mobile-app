        ...
        <Box className="flex-1 justify-center p-6">
          <VStack space="xl" className="items-center">
            <VStack space="lg" className="items-center mb-8">
              <Box className="p-6 bg-gradient-to-br from-yellow-200 to-orange-300 rounded-full shadow-xl border-4 border-yellow-400 transform rotate-3">
                <Icon as={Shield} size="xl" className="text-orange-600" />
              </Box>
              <VStack space="xs" className="items-center">
                <Heading
                  size="2xl"
                  className="text-center font-black bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"
                >
                ...
                >
                  Ready to save the planet together? Let's go! 🚀
                </Text>
              </VStack>
            </VStack>
